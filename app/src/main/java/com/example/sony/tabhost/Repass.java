...
import com.example.sony.tabhost.R;
...
public class Repass extends AppCompatActivity {
    ...
    public void btn_reset_password (View v) {
        ...
        if (!checkemail(email)) {
            ...
            Toast.makeText(getApplication(), "E-mail badly formed", Toast.LENGTH_SHORT).show();
    ...
    public void btn_back(View v) {finish();}
    //check email format
